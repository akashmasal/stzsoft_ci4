                                    ...
                                    <div class="hero-content-wrapper">
                                        <div class="hero-content-wrap">
                                            <div class="hero-content-img">
                                                <img src="<?= base_url();?>/assets/website/img/hero-slider-1.jpg" alt="">
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="hero-content-wrapper">
                                        <div class="hero-content-wrap">
                                            <div class="hero-content-img">
                                                <img src="<?= base_url();?>/assets/website/img/hero-slider-2.png" alt="">
                                            </div>
                                            <div class="hero-content">
                                                <h2>Creative</h2>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="hero-content-wrapper">
                                        <div class="hero-content-wrap">
                                            <div class="hero-content-img">
                                                <img src="<?= base_url();?>/assets/website/img/hero-slider-3.png" alt="">
                                            </div>
                                            <div class="hero-content">
                                                <h2>Creative</h2>
                        ...
                        <div class="row g-4">
                            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                <div class="single-service">
                                    ...
                                    <div class="service-icon">
                                        <i><img src="<?= base_url();?>/assets/website/img/icons/service-icon-1.png" alt=""></i>
                                    </div>
                                    <div class="service-content">
                                        <h4>web design</h4>
                                        <p>Fusce ornare mauris nisi, id fringilla turpis vehicula justo lectus,
                                            ultricies nec sem</p>
                                        <a href="services.html">read more<i><img src="<?= base_url();?>/assets/website/img/icons/arrow-circle.png"
                                                    alt=""></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                <div class="single-service">
                                    ...
                                    <div class="service-icon">
                                        <i><img src="<?= base_url();?>/assets/website/img/icons/service-icon-2.png" alt=""></i>
                                    </div>
                                    <div class="service-content">
                                        <h4>App design</h4>
                                        ...
                                        <a href="service-details.html">read more<i><img
                                                    src="<?= base_url();?>/assets/website/img/icons/arrow-circle.png" alt=""></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                <div class="single-service">
                                    ...
                                    <div class="service-icon">
                                        <i><img src="<?= base_url();?>/assets/website/img/icons/service-icon-3.png" alt=""></i>
                                    </div>
                                    <div class="service-content">
                                        <h4>Developing</h4>
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                <div class="single-service">
                                    ...
                                    <div class="service-icon">
                                        <i><img src="<?= base_url();?>/assets/website/img/icons/service-icon-4.png" alt=""></i>
                                    </div>
                                    <div class="service-content">
                    ...
                    <div class="col-lg-6 col-xl-6">
                        <div class="about-left">
                            ...
                            <div class="our-mission">
                                <div class="msn-icon">
                                    <i><img src="<?= base_url();?>/assets/website/img/icons/mission-icon.png" alt=""></i>
                                </div>
                                ...
                                <div class="cto">
                                    <img src="<?= base_url();?>/assets/website/img/ctoFounder.png" alt="">
                                </div>
                            </div>
                            <div class="cmn-btn">
                    ...
                    <div class="col-lg-6 col-xl-6">
                        <div class="about-right">
                            <div class="group-images">
                                <img src="<?= base_url();?>/assets/website/img/about-bottom.jpg" alt="">
                                <div class="about-top">
                                    <img src="<?= base_url();?>/assets/website/img/about-top.png" alt="">
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-3 col-lg-3 col-xl-3">
                            <div class="single-count">
                                <i><img src="<?= base_url();?>/assets/website/img/icons/count-1.png" alt=""></i>
                                <div class="counter">
                        ...
                        <div class="col-sm-6 col-md-3 col-lg-3 col-xl-3">
                            <div class="single-count">
                                <i><img src="<?= base_url();?>/assets/website/img/icons/count-2.png" alt=""></i>
                                <div class="counter">
                        ...
                        <div class="col-sm-6 col-md-3 col-lg-3 col-xl-3">
                            <div class="single-count">
                                <i><img src="<?= base_url();?>/assets/website/img/icons/count-3.png" alt=""></i>
                                <div class="counter">
                                    <span class="odometer">150</span><sup>+</sup>
                                </div>
                                <p>Expert Teams</p>
                        ...
                        <div class="col-sm-6 col-md-3 col-lg-3 col-xl-3">
                            <div class="single-count xsm">
                                <i><img src="<?= base_url();?>/assets/website/img/icons/count-4.png" alt=""></i>
                                <div class="counter">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                                    <div class="single-client">
                                        <img src="<?= base_url();?>/assets/website/img/partner-icons/partner-1.png" alt="">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                                    <div class="single-client">
                                        <img src="<?= base_url();?>/assets/website/img/partner-icons/partner-2.png" alt="">
                                        <div class="client-hover">
                                            <span>www.example.com</span>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                                    <div class="single-client">
                                        <img src="<?= base_url();?>/assets/website/img/partner-icons/partner-3.png" alt="">
                                        <div class="client-hover">
                                            <span>www.example.com</span>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                                    <div class="single-client">
                                        <img src="<?= base_url();?>/assets/website/img/partner-icons/partner-4.png" alt="">
                                        <div class="client-hover">
                                            <span>www.example.com</span>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                                    <div class="single-client">
                                        <img src="<?= base_url();?>/assets/website/img/partner-icons/partner-5.png" alt="">
                                        <div class="client-hover">
                                            <span>www.example.com</span>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                                    <div class="single-client">
                                        <img src="<?= base_url();?>/assets/website/img/partner-icons/partner-6.png" alt="">
                                        <div class="client-hover">
                                            <span>www.example.com</span>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                                    <div class="single-client">
                                        <img src="<?= base_url();?>/assets/website/img/partner-icons/partner-7.png" alt="">
                                        <div class="client-hover">
                                            <span>www.example.com</span>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                                    <div class="single-client">
                                        <img src="<?= base_url();?>/assets/website/img/partner-icons/partner-8.png" alt="">
                                        <div class="client-hover">
                                            <span>www.example.com</span>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                                    <div class="single-client">
                                        <img src="<?= base_url();?>/assets/website/img/partner-icons/partner-9.png" alt="">
                                        <div class="client-hover">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                                    <div class="single-client">
                                        <img src="<?= base_url();?>/assets/website/img/partner-icons/partner-10.png" alt="">
                                        <div class="client-hover">
                                            <span>www.example.com</span>
                                        </div>
                                    </div>
            ...
            <div class="swiper portfolio-slider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="single-portfolio">
                            <div class="portfolio-data">
                                <a href="#"><img src="<?= base_url();?>/assets/website/img/portfolio/portfolio-1.jpg" alt=""></a>
                            </div>
                            <div class="portfolio-inner">
                                ...
                                <div class="portfolio-hover">
                                    ...
                                    <a data-lightbox="image1" href="<?= base_url();?>/assets/website/img/portfolio/portfolio-1.jpg"><i
                    ...
                    <div class="swiper-slide">
                        <div class="single-portfolio">
                            <div class="portfolio-data">
                                <a href="#"><img src="<?= base_url();?>/assets/website/img/portfolio/portfolio-2.jpg" alt=""></a>
                            </div>
                            <div class="portfolio-inner">
                                <span>UI Kit</span>
                                ...
                                <div class="portfolio-hover">
                                    <a href="project-details.html" class="case-btn">Case Study</a>
                                    <a data-lightbox="image1" href="<?= base_url();?>/assets/website/img/portfolio/portfolio-2.jpg"><i
                                            class="fas fa-search"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="single-portfolio">
                            <div class="portfolio-data">
                                <a href="#"><img src="<?= base_url();?>/assets/website/img/portfolio/portfolio-3.jpg" alt=""></a>
                            </div>
                            <div class="portfolio-inner">
                                <span>Software</span>
                                ...
                                <div class="portfolio-hover">
                                    <a href="project-details.html" class="case-btn">Case Study</a>
                                    <a data-lightbox="image1" href="<?= base_url();?>/assets/website/img/portfolio/portfolio-3.jpg"><i
                                            class="fas fa-search"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="single-portfolio">
                            <div class="portfolio-data">
                                <a href="#"><img src="<?= base_url();?>/assets/website/img/portfolio/portfolio-4.jpg" alt=""></a>
                            </div>
                            <div class="portfolio-inner">
                                <span>Graphic</span>
                                ...
                                <div class="portfolio-hover">
                                    <a href="project-details.html" class="case-btn">Case Study</a>
                                    <a data-lightbox="image1" href="<?= base_url();?>/assets/website/img/portfolio/portfolio-4.jpg"><i
                                            class="fas fa-search"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="single-portfolio">
                            <div class="portfolio-data">
                                <a href="#"><img src="<?= base_url();?>/assets/website/img/portfolio/portfolio-5.jpg" alt=""></a>
                            </div>
                            <div class="portfolio-inner">
                                <span>App</span>
                                ...
                                <div class="portfolio-hover">
                                    <a href="project-details.html" class="case-btn">Case Study</a>
                                    <a data-lightbox="image1" href="<?= base_url();?>/assets/website/img/portfolio/portfolio-5.jpg"><i
                                            class="fas fa-search"></i></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6 col-xl-6">
                        ...
                        <div class="video-demo">
                            <img src="<?= base_url();?>/assets/website/img/play-video.jpg" alt="">
                            <div class="play-btn">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-6">
                        <div class="valuable-skills">
                            <img src="<?= base_url();?>/assets/website/img/valuable-skill.jpg" alt="">
                            ...
                            <div class="swiper-wrapper">
                                    ...
                                    <div class="testimonial-content">
                                        ...
                                        <div class="client-info">
                                            <div class="client-pic">
                                                <img src="<?= base_url();?>/assets/website/img/client.jpg" alt="">
                                            </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-content">
                                        ...
                                        <div class="client-info">
                                            <div class="client-pic">
                                                <img src="<?= base_url();?>/assets/website/img/client-2.jpg" alt="">
                                            </div>
                                            <div class="client-details">
                                                <h4>Nailong Jeso</h4>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-content">
                                        ...
                                        <div class="client-info">
                                            <div class="client-pic">
                                                <img src="<?= base_url();?>/assets/website/img/client-3.jpg" alt="">
                                            </div>
                                            <div class="client-details">
                                                <h4>Gautam Yamni</h4>
                ...
                <div class="row gx-4">
                    <div class="col-md-6 col-lg-4 col-xl-4">
                        <div class="signle-news">
                            ...
                            <div class="post-img">
                                <a href="blog_details.html"><img src="<?= base_url();?>/assets/website/img/post/post-1.jpg" alt=""></a>
                            </div>
                            <div class="news-content">
                                <div class="author">
                                    <div class="author-pic">
                                        <img src="<?= base_url();?>/assets/website/img/author/author-1.jpg" alt="">
                                    </div>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-4">
                        <div class="signle-news">
                            ...
                            <div class="post-img">
                                <a href="blog_details.html"><img src="<?= base_url();?>/assets/website/img/post/post-2.jpg" alt=""></a>
                            </div>
                            <div class="news-content">
                                <div class="author">
                                    <div class="author-pic">
                                        <img src="<?= base_url();?>/assets/website/img/author/author-2.jpg" alt="">
                                    </div>
                                    <div class="author-info">
