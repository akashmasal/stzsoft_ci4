                ...
                <div class="col-lg-6 col-xl-6">
                    <div class="story-left">
                        <div class="office-group-img">
                            <img src="<?= base_url(); ?>/assets/website/img/story.png" alt="">
                            <div class="cto-message-wrapper">
                                <div class="cto-message">
                                    ...
                                    <img src="<?= base_url(); ?>/assets/website/img/cto-signature.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row gx-4">
            <div class="col-md-6 col-lg-4 col-xl-4">
                <div class="signle-news">
                    ...
                    <div class="post-img">
                        <a href="blog_details.html"><img src="<?= base_url(); ?>/assets/website/img/post/post-1.jpg"
                                alt=""></a>
                    </div>
            ...
            <div class="col-md-6 col-lg-4 col-xl-4">
                <div class="signle-news">
                    ...
                    <div class="post-img">
                        <a href="blog_details.html"><img src="<?= base_url(); ?>/assets/website/img/post/post-2.jpg"
                                alt=""></a>
                    </div>
                    <div class="news-content">
                        <div class="author">
