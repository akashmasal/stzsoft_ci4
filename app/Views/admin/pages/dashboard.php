    ...
    <body data-sidebar="dark">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            ...
                            <a href="index-2.html" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="<?= base_url();?>/assets/admin/images/logo-light.png" alt="" height="18">
                                </span>
                            </a>
                        </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card mini-stat bg-primary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            <div class="float-start mini-stat-img me-4">
                                                <img src="<?= base_url();?>/assets/admin/images/services-icon/02.png" alt="">
                                            </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card mini-stat bg-primary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            <div class="float-start mini-stat-img me-4">
                                                <img src="<?= base_url();?>/assets/admin/images/services-icon/03.png" alt="">
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <h6 class="mb-0"><img src="<?= base_url();?>/assets/admin/images/users/user-3.jpg" alt=""
                                            ...
                                            <table class="table table-hover table-centered table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="<?= base_url();?>/assets/admin/images/users/user-2.jpg" alt=""
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="<?= base_url();?>/assets/admin/images/users/user-3.jpg" alt=""
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="<?= base_url();?>/assets/admin/images/users/user-4.jpg" alt=""
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="<?= base_url();?>/assets/admin/images/users/user-5.jpg" alt=""
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="<?= base_url();?>/assets/admin/images/users/user-6.jpg" alt=""
                                                ...
                                                <li class="clearfix odd">
                                                    ...
                                                    <div class="conversation-text">
                                                        <div class="ctext-wrap">
                                                            ...
                                                            <img src="<?= base_url();?>/assets/admin/images/small/img-1.jpg" alt="" height="48"
                                                                class="rounded me-2">
                                                            <img src="<?= base_url();?>/assets/admin/images/small/img-2.jpg" alt="" height="48"
                                                                class="rounded">
                                                        </div>
                                                    </div>
                                                </li>
        ...
        <div class="right-bar">
            <div data-simplebar class="h-100">
                ...
                <div class="p-4">
                    <div class="mb-2">
                        <img src="<?= base_url();?>/assets/admin/images/layouts/layout-1.jpg" class="img-fluid img-thumbnail" alt="">
                    </div>
                    ...
                    <div class="mb-2">
                        <img src="<?= base_url();?>/assets/admin/images/layouts/layout-2.jpg" class="img-fluid img-thumbnail" alt="">
                    </div>
                    <div class="form-check form-switch mb-3">
                        <input type="checkbox" class="form-check-input theme-choice" id="dark-mode-switch" data-bsStyle="<?= base_url();?>/assets/admin/css/bootstrap-dark.min.css" 
                            data-appStyle="<?= base_url();?>/assets/admin/css/app-dark.min.css" />
                        <label class="form-check-label" for="dark-mode-switch">Dark Mode</label>
                    </div>
    
                    <div class="mb-2">
                        <img src="<?= base_url();?>/assets/admin/images/layouts/layout-3.jpg" class="img-fluid img-thumbnail" alt="">
                    </div>
                    <div class="form-check form-switch mb-5">
                        <input type="checkbox" class="form-check-input theme-choice" id="rtl-mode-switch" data-appStyle="<?= base_url();?>/assets/admin/css/app-rtl.min.css" />
...
<!-- Mirrored from themesbrand.com/veltrix/layouts/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 11:50:42 GMT -->
</html>